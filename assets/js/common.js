$(document).ready(function () {
    $('.dark_btn').on('click', function () {
        ...
        $('.gnb_logo').children().find('img').attr({src: 'assets/images/logo/logo2_white.png'});
    ...
    $('.light_btn').on('click', function () {
        ...
        $(this).css('display', 'none');
        $('.gnb_logo').children().find('img').attr({src: 'assets/images/logo/logo2.png'});
    ...
    $(window).on('scroll', function () {
        ...
        if (scrollY >= 100) $('.top_btn').css('bottom', 90);
        else $('.top_btn').css('bottom', 20);
